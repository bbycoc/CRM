...
<script type="text/javascript">
		...
		$.ajax({
			...
			success:function (data){
				...
				$.each(data,function (i,n){
					...
					html+='<td>'+n.endDate+'</td>'
					html+='<td>'+n.owner+'</td>'
					html+='<td><a href="javascript:void(0);" style="text-decoration: none;"  onclick="delActivity(\''+n.id+'\')"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>'
					html+='</tr>'
				})
	...
	function delActivity(id) {
		$.ajax({
			url:"workbench/clue/delActivityList.do",
			data:{
				"activityId":id,
				"clueId":"${c.id}"
			},

...
<script type="text/javascript">
	...
	function culeList(pageNo, pageSize) {
		$.ajax({
			...
			data: {
				...
				"source":$.trim($("#search-source option:selected").text()),
				"owner":$.trim($("#search-owner").val()),
				"mphone":$.trim($("#search-mphone").val()),
				"state":$.trim($("#search-state option:selected").text())
			},
			type:"get",
			dataType:"json",
			success:function (data){
				...
				$("#activityPage").bs_pagination({
					...
					onChangePage : function(event, data){
						culeList(data.currentPage , data.rowsPerPage);
					}
				});
			}
		})
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 40px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  <button type="button" class="btn btn-primary" data-toggle="modal" id="addClueButtn"><span class="glyphicon glyphicon-plus"></span> 创建</button>
				...
				<table class="table table-hover">
					...
					<tbody id="clueList">
						<%--<tr>
							...
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detail.do';">李先生</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>

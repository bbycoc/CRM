...
<script type="text/javascript">
	...
	$(function(){
        ...
        $("#saveRemark").click(function () {
            $.ajax({
                ...
                success:function (data){
                    if(data.success){
                        var html="";
                        html+='<div id="'+data.ra.id+'" class="remarkDiv" style="height: 60px;">';
                        html+='<img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
                        html+='<div style="position: relative; top: -40px; left: 40px;" >';
                        html+='<h5 id="n'+data.ra.id+'">'+data.ra.noteContent+'</h5>';
                        html+='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;" id="s'+data.ra.id+'"> '+(data.ra.createTime)+' 由 '+(data.ra.createBy)+'</small>';
                        html+='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                        html+='<a class="myHref" href="javascript:void(0);"onclick="updateRemark(\''+data.ra.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #ff0000;"></span></a>';
                        html+='&nbsp;&nbsp;&nbsp;&nbsp;';
                        html+='<a class="myHref" href="javascript:void(0);"onclick="deleteRemark(\''+data.ra.id+'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: red;"></span></a>';
                        html+='</div>';
                        html+='</div>';
                        html+='</div>';
        ...
        $("#updateRemarkBtn").click(function () {
            ...
            $.ajax({
                ...
                success:function (data){
                    if (data.success){
                        $("#n"+id).html(data.ra.noteContent);
                        $("#s"+id).html(data.ra.editTime+"由"+data.ra.editBy);
	...
	function remarkActivity() {
		$.ajax({
			url:"workbench/activity/getRAbyId.do",
			data:{
				"activityId":"${a.id}"
			},
			type:"get",

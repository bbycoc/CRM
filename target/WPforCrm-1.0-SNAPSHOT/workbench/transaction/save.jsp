...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;" action="/workbench/transaction/save.do" method="post" id="saveForm">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="发传单3">
				<input type="hidden" value="8d4f2ee5dacd4b4aa0615d4918f1fd32" name="aid">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="小李">
				<input type="hidden" value="1d4e8d2da6af4562a0ff4baf1d99ade7" name="contactsId">
			</div>
		</div>
